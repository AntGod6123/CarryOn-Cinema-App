...
Sonic analyzer data inclusion for creating playlists:
...
Future https self signed certs. 
...
In the Settings section, Home Details Setting where the admin can change the order of the libraries being shown on the home page. 
Languages translation capable.
